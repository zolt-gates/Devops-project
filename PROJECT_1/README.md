...
`mkdir -p` is an option for the mkdir command that allows you to create parent directories as needed. If the specified path includes directories that don't exist, it creates them as shown below
